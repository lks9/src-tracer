...
lib/libsrc_tracer.a: lib/src_tracer/trace_buf.o lib/src_tracer/common.o lib/src_tracer/retrace_mode.o lib/src_tracer/mmap_to_trace.o lib/src_tracer/tracer_create_daemon.o
	ar rcs $@ $^
